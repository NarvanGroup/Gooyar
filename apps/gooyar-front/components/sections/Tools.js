            ...
            <div className="col-lg-12">
              <div className="section-title text-center mb-80">
                <h2 className="title title-animation">
                  امکان ساخت 10+ <span>دستیار هوشمند</span>
                </h2>
              </div>
            </div>
          </div>
          <div className="row justify-content-center row-cols-1 row-cols-xl-5 row-cols-lg-3 row-cols-md-3 row-cols-sm-2">
            <div className="col">
              <div className="tools-item">
                ...
                <div className="tools-content">
                  <h4 className="title">
                    <Link href="/login">منشی هوشمند</Link>
                  </h4>
            ...
            <div className="col">
              <div className="tools-item">
                ...
                <div className="tools-content">
                  <h4 className="title">
                    <Link href="/login">پذیرش هوشمند</Link>
                  </h4>
                  <Link href="/login" className="link-btn">
                    مشاهده دمو
                    <ChevronLeftOutlined />
            ...
            <div className="col">
              <div className="tools-item">
                ...
                <div className="tools-content">
                  <h4 className="title">
                    <Link href="/login">پشتیبانی هوشمند</Link>
                  </h4>
                  <Link href="/login" className="link-btn">
                    مشاهده دمو
                    <ChevronLeftOutlined />
            ...
            <div className="col">
              <div className="tools-item">
                ...
                <div className="tools-content">
                  <h4 className="title">
                    <Link href="/login">مارکتینگ هوشمند</Link>
                  </h4>
                  <Link href="/login" className="link-btn">
                    مشاهده دمو
                    <ChevronLeftOutlined />
            ...
            <div className="col">
              <div className="tools-item">
                ...
                <div className="tools-content">
                  <h4 className="title">
                    <Link href="/login">مشاور هوشمند</Link>
                  </h4>
                  <Link href="/login" className="link-btn">
                    مشاهده دمو
                    <ChevronLeftOutlined />
