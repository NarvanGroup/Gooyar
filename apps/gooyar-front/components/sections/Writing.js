            ...
            <div className="col-lg-12">
              <div className="section-title text-center mb-80">
                <h2 className="title title-animation">
                  سرعت پاسخگویی به مشتریان را 10 برابر افزایش دهید
                </h2>
              </div>
            </div>
          </div>
          <div className="row justify-content-center">
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
              <div className="writing-item">
                ...
                <div className="writing-content">
                  <h4 className="title">دسترسی چندکاناله</h4>
                  <p>
                    پاسخ‌دهی خودکار در واتساپ، اینستاگرام، تلگرام، پیام‌رسان های
                    ایرانی و تماس صوتی
                  </p>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
              <div className="writing-item">
                ...
                <div className="writing-content">
                  <h4 className="title">پاسخ‌های دقیق و شخصی‌سازی‌شده</h4>
                  <p>
                    آموزش‌دیده بر اساس سوالات پرتکرار، اسناد شما، پایگاه دانش یا
                    CRM داخلی
                  </p>
                  {/* <Link href="/work" className="link-btn">
                    Try use of AI
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
              <div className="writing-item">
                ...
                <div className="writing-content">
                  <h4 className="title">پشتیبانی متنی و صوتی</h4>
                  <p>
                    هم در چت بنویسید، هم با صدای واقعی انسانی پاسخ بدهید به زبان
                    فارسی
                  </p>
                  {/* <Link href="/work" className="link-btn">
                    Try conversions
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
              <div className="writing-item">
                ...
                <div className="writing-content">
                  <h4 className="title">نظارت و گزارش‌دهی کامل</h4>
                  <p>
                    تمام گفتگوها ثبت می‌شوند؛ با امکان نظارت، تایید و استخراج
                    گزارش عملکرد تیم
                  </p>
                  {/* <Link href="/work" className="link-btn">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
              <div className="writing-item">
                ...
                <div className="writing-content">
                  <h4 className="title">اتصال به ابزارهای رزرو و فروش</h4>
                  <p>
                    گرفتن وقت پزشک، رزرو هتل، ثبت سفارش یا پیگیری مرسوله با چند
                    کلیک
                  </p>
                  {/* <Link href="/work" className="link-btn">
                    Try streamline
            ...
            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
              <div className="writing-item">
                ...
                <div className="writing-content">
                  <h4 className="title">صرفه‌جویی در زمان و هزینه</h4>
                  <p>
                    بدون نیاز به استخدام اپراتور؛ مقیاس‌پذیر، اقتصادی و همیشه در
                    دسترس
                  </p>
                  {/* <Link href="/work" className="link-btn">
