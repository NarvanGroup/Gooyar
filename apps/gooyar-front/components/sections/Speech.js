                  ...
                  <div className="form-grp">
                    ...
                    <div className="form-content">
                      <span>
                        ...
                        For more <br /> usage and premium voices, you can
                        purchase packages.
                      </span>
            ...
            <div className="col-lg-6 col-md-10">
              <div className="speech-item">
                ...
                <form action="#" className="engine-form-two">
                  ...
                  <div className="form-content">
                    <span>
                      Voicer Transcribe free use is limited to 5 minutes. You
                      can <br /> purchase packages for more use and to
                      transcribe longer files.
                    </span>
