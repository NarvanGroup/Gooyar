                        ...
                        <div className="vioces-item">
                          ...
                          <div className="vioces-content">
                            ...
                            <ul className="list-wrap">
                              <li>
                                <Link href="#">Confident</Link>
                              </li>
                              <li>
                                <Link href="#">Bold</Link>
                              </li>
                              <li>
                                <Link href="#">Authoritative</Link>
                              </li>
                              <li>
                                <Link href="#">Bossy</Link>
                              </li>
                              <li>
                                <Link href="#">Charismatic</Link>
                              </li>
                            </ul>
                          </div>
                        </div>
                        ...
                        <div className="vioces-item">
                          ...
                          <div className="vioces-content">
                            ...
                            <ul className="list-wrap">
                              ...
                              <li>
                                <Link href="#">Approachable</Link>
                              </li>
                              <li>
                                <Link href="#">Commanding</Link>
                              </li>
                              <li>
                                <Link href="#">Heroic</Link>
                              </li>
                              <li>
                                <Link href="#">Tough</Link>
                              </li>
                            </ul>
                          </div>
                        </div>
