...
const Banner = () => {
  ...
  const { isOpen, open: openAuthModal, close } = useAuthStateStore();
  ...
  return (
    <Box borderRadius={0} bgcolor="primary.light" pt={7}>
      <Container
        sx={{
        ...
        <Grid container spacing={3} justifyContent="center" mb={4}>
          ...
          <Grid size={{ xs: 12, lg: 7 }} textAlign="center">
            ...
            >
              ...
              {/* {"  "} راهکاری مطمئن برای تأیید هویت خریداران{"  "} */}
            </Typography>
            <Typography
              variant="h1"
              sx={{
              ...
              // color="primary.main"
            >
              برای امنیت راه بهتری هم هست ...
              {/* حفاظت از معامله‌ها، جلوگیری از کلاهبرداری */}
            </Typography>
            <Stack
              mt={8}
              mb={3}
